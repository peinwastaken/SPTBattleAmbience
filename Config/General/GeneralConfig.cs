...
namespace SPTBattleAmbience.Config.General
{
    public static class GeneralConfig
    {
        ...
        public static void Bind(ConfigFile config)
        {
            ...
            UseEventConfigWeights = config.Bind(category, "Use Event Weights", true, new ConfigDescription("Use assigned weights when selecting random events", null, new ConfigurationManagerAttributes { Order = 988, IsAdvanced = true }));
